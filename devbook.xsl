                                                ...
                                                <div class="collapse navbar-collapse" id="gw-toolbar">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn">
                                                            <input type="submit" name="fulltext" value="Search" title="Search the pages for this text" id="mw-searchButton" class="searchButton btn btn-default"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10 col-sm-9 col-md-10">
                                                <strong>Copyright (C) 2001-2018 Gentoo Foundation, Inc.</strong><br />
                                                <small>
